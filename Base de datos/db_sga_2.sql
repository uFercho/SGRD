...
--
-- Servidor: localhost
-- Tiempo de generación: 19-01-2011 a las 20:17:49
...
DROP TABLE IF EXISTS `tm_cam_campana`;
...
DROP TABLE IF EXISTS `tm_cro_cronograma`;
CREATE TABLE IF NOT EXISTS `tm_cro_cronograma` (
  ...
  KEY `cro_id` (`cro_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4078 ;
...
DROP TABLE IF EXISTS `tm_reg_registro2f`;
...
DROP TABLE IF EXISTS `tm_reg_registro3f`;
CREATE TABLE IF NOT EXISTS `tm_reg_registro3f` (
  ...
  UNIQUE KEY `cro_id` (`cro_id`,`reg_row`),
  KEY `FK_reg_cro` (`cro_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=106998 ;
...
DROP TABLE IF EXISTS `tm_sce_sobrecarga_equipo`;
...
DROP TABLE IF EXISTS `tm_scu_sobrecarga_unidad`;
...
DROP TABLE IF EXISTS `tm_tre_tree_menu`;
CREATE TABLE IF NOT EXISTS `tm_tre_tree_menu` (
  ...
  PRIMARY KEY (`tre_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3695 ;
